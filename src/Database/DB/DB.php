...
class DB implements DBInterface
{
    ...
    public function __construct($pdo)
    {
        ...
        $this->prefix = isset(App::get('config')['database']['prefix'])
            ? App::get('config')['database']['prefix']
            : '';
        $this->cacheDir = isset(App::get('config')['database']['cachedir'])
            ? App::get('config')['database']['cachedir']
            : __DIR__ . '/cache/';
    }
